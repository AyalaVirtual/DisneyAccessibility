...
public class AttractionAccessibilityController {
    ...
    /**
     * Retrieves the accessibility details for a specific attraction by its accessibility ID.
     *
    ...
    public ResponseEntity<?> getAttractionAccessibilityById(@PathVariable(value = "attractionAccessibilityId") Long attractionAccessibilityId) {
        try {
            Optional<AttractionAccessibility> attractionAccessibilityOptional = attractionAccessibilityService.getAttractionAccessibilityById(attractionAccessibilityId);
