...
public class AttractionAccessibilityControllerTest {
    ...
    public void getAttractionAccessibilityRecord_success() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/parks/{parkId}/attractions/{attractionId}/attractionaccessibility/{id}/", "1", "1", "1")
                ...
                .andExpect(jsonPath("$.data.serviceAnimalRestrictions.serviceAnimalRideRestrictions").value(cinderellasCastleA11y.getServiceAnimalRestrictions().getServiceAnimalRideRestrictions()))
                .andExpect(jsonPath("$.data.serviceAnimalRestrictions.serviceAnimalBoardingRestrictions").value(cinderellasCastleA11y.getServiceAnimalRestrictions().getServiceAnimalBoardingRestrictions()))
