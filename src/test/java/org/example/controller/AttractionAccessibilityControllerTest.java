...
public class AttractionAccessibilityControllerTest {
    ...
    public void getAttractionAccessibilityRecord_success() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/parks/{parkId}/attractions/{attractionId}/attractionaccessibility/{id}/", "1", "1", "1")
                ...
                .andExpect(jsonPath("$.data.serviceAnimalRestrictions.rideRestrictions").value(cinderellasCastleA11y.getServiceAnimalRestrictions().getServiceAnimalRideRestrictions()))
                .andExpect(jsonPath("$.data.serviceAnimalRestrictions.boardRestrictions").value(cinderellasCastleA11y.getServiceAnimalRestrictions().getServiceAnimalBoardingRestrictions()))
